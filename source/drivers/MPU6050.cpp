...
MPU6050::MPU6050(I2C& _i2c, Pin& _int1, CoordinateSpace& coordinateSpace, uint16_t address, uint16_t id)
...
int MPU6050::configure()
{
    ...
    fiber_sleep(20);
    i2c.writeRegister(address, 0x6B,
                      0x00); /* PWR_MGMT_1    -- SLEEP 0; CYCLE 0; TEMP_DIS 0; CLKSEL 3 (PLL with Z Gyro reference) */
    i2c.writeRegister(address, 0x1A, 0x01); /* CONFIG        -- EXT_SYNC_SET 0 (disable input pin for data sync) ;
